...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2020 at 09:27 AM
...
(19799, 'Ardhillah Habibi Alfath', NULL, NULL, NULL, NULL, NULL, NULL, 91, 2),
(19800, 'Ariq Artriska', NULL, NULL, NULL, NULL, NULL, NULL, 81, 2),
(19801, 'Bagas Lintang Wicaksono', NULL, NULL, NULL, NULL, NULL, NULL, 81, 2),
...
--
ALTER TABLE `tb_monitoring`
  MODIFY `id_monitoring` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_monitoring_detail`
--
ALTER TABLE `tb_monitoring_detail`
  MODIFY `id_monitoring_detail` bigint(20) NOT NULL AUTO_INCREMENT;
COMMIT;
